...
public class EnchantmentRingArmor extends Enchantment {
    ...
    public void onDamage(LivingHurtEvent event) {
        if(event.getEntityLiving() != null) {
            ...
            if(event.getSource().getTrueSource() instanceof EntityArrow && level > 0 && !(entityLiving.isPotionActive(PotionInit.VENOM) || EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SOMBER, entityLiving.getItemStackFromSlot(EntityEquipmentSlot.LEGS)) > 0)) {
